...
import 'package:twitter_clone/common_widgets/tweet/tweetImage.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child:
                // type == TweetType.Tweet || type == TweetType.Reply
                //     ? _TweetBody(
            ...
            children: <Widget>[
              ListTile(
                ...
                leading: GestureDetector(
                  onTap: () {},
                  child: const CircularImage(path: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6TaCLCqU4K0ieF27ayjl51NmitWaJAh_X0r1rLX4gMvOe0MDaYw&s'),
                ),
                title: Row(
                  children: <Widget>[
                    ConstrainedBox(
                      constraints: BoxConstraints(
                          minWidth: 0, maxWidth: context.width * .5),
                      child: const Text("model.user!.displayName!",
                          style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w800,
                              overflow: TextOverflow.ellipsis)),
